...
if debug
    ...
    mex -v -win64 COMPFLAGS="$COMPFLAGS /MT /openmp" -I"../HuygensOnSpeed" -I"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v5.0\include" -lHuygensOnSpeed -L"cuda_5_0" HuygensOnSpeed.cpp
end